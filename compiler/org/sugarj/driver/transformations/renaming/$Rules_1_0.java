...
{ 
  ...
  { 
    ...
    { 
      ...
      k_96 = annos33;
      term = f_12.invoke(context, j_96);
      if(term == null)
        break Fail43;
      term = termFactory.annotateTerm(termFactory.makeAppl(out._consRules_1, new IStrategoTerm[]{term}), checkListAnnos(termFactory, k_96));
