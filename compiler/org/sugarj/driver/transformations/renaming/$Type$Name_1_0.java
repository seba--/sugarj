...
{ 
  ...
  { 
    ...
    { 
      ...
      g_132 = annos153;
      term = d_26.invoke(context, f_132);
      if(term == null)
        break Fail172;
      term = termFactory.annotateTerm(termFactory.makeAppl(renaming._consTypeName_1, new IStrategoTerm[]{term}), checkListAnnos(termFactory, g_132));
