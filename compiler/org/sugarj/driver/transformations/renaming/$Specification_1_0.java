...
{ 
  ...
  { 
    ...
    { 
      ...
      w_96 = annos37;
      term = j_12.invoke(context, v_96);
      if(term == null)
        break Fail47;
      term = termFactory.annotateTerm(termFactory.makeAppl(out._consSpecification_1, new IStrategoTerm[]{term}), checkListAnnos(termFactory, w_96));
