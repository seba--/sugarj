...
{ 
  ...
  { 
    ...
    { 
      ...
      k_105 = annos78;
      term = k_15.invoke(context, j_105);
      if(term == null)
        break Fail89;
      term = termFactory.annotateTerm(termFactory.makeAppl(out._consTest_1, new IStrategoTerm[]{term}), checkListAnnos(termFactory, k_105));
