...
{ 
  ...
  { 
    ...
    varScope.addSVar("replace_name_0_2", new InteropSDefT(replace_name_0_2.instance, context));
  ...
  { 
    ...
    varScope.addSVar("replace_name_0_2", new InteropSDefT(classLoader, "org.sugarj.driver.transformations.renaming.replace_name_0_2", context));
