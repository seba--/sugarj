...
{ 
  ...
  { 
    ...
    { 
      ...
      v_109 = annos48;
      term = m_18.invoke(context, u_109);
      if(term == null)
        break Fail60;
      term = termFactory.annotateTerm(termFactory.makeAppl(renaming._consInstanceInit_1, new IStrategoTerm[]{term}), checkListAnnos(termFactory, v_109));
