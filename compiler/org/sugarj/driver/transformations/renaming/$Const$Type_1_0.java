...
{ 
  ...
  { 
    ...
    { 
      ...
      s_109 = annos101;
      term = x_16.invoke(context, r_109);
      if(term == null)
        break Fail114;
      term = termFactory.annotateTerm(termFactory.makeAppl(out._consConstType_1, new IStrategoTerm[]{term}), checkListAnnos(termFactory, s_109));
