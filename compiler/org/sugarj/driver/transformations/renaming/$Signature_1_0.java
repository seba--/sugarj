...
{ 
  ...
  { 
    ...
    { 
      ...
      k_96 = annos34;
      term = d_12.invoke(context, j_96);
      if(term == null)
        break Fail44;
      term = termFactory.annotateTerm(termFactory.makeAppl(out._consSignature_1, new IStrategoTerm[]{term}), checkListAnnos(termFactory, k_96));
