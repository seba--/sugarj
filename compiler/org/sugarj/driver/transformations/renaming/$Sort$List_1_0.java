...
{ 
  ...
  { 
    ...
    { 
      ...
      m_111 = annos110;
      term = o_17.invoke(context, l_111);
      if(term == null)
        break Fail123;
      term = termFactory.annotateTerm(termFactory.makeAppl(out._consSortList_1, new IStrategoTerm[]{term}), checkListAnnos(termFactory, m_111));
