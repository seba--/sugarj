...
{ 
  ...
  { 
    ...
    { 
      ...
      b_96 = annos31;
      term = a_12.invoke(context, a_96);
      if(term == null)
        break Fail41;
      term = termFactory.annotateTerm(termFactory.makeAppl(out._consImport_1, new IStrategoTerm[]{term}), checkListAnnos(termFactory, b_96));
