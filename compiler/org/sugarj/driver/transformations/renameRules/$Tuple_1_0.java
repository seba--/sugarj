...
{ 
  ...
  { 
    ...
    { 
      ...
      o_113 = annos124;
      term = f_18.invoke(context, n_113);
      if(term == null)
        break Fail134;
      term = termFactory.annotateTerm(termFactory.makeAppl(out._consTuple_1, new IStrategoTerm[]{term}), checkListAnnos(termFactory, o_113));
