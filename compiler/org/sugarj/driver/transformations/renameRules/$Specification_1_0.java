  ...
  { 
    ...
    { 
      ...
      if(term.getTermType() != IStrategoTerm.APPL || out._consSpecification_1 != ((IStrategoAppl)term).getConstructor())
        break Fail43;
      t_96 = term.getSubterm(0);
      IStrategoList annos37 = term.getAnnotations();
      u_96 = annos37;
      term = h_12.invoke(context, t_96);
      if(term == null)
        break Fail43;
      term = termFactory.annotateTerm(termFactory.makeAppl(out._consSpecification_1, new IStrategoTerm[]{term}), checkListAnnos(termFactory, u_96));
