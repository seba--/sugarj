...
{ 
  ...
  @Override public IStrategoTerm invoke(Context context, IStrategoTerm term, Strategy w_12, Strategy x_12, Strategy y_12, Strategy z_12)
  { 
    ...
    { 
      ...
      w_98 = term.getSubterm(2);
      x_98 = term.getSubterm(3);
      ...
      if(term == null)
        break Fail51;
      term = termFactory.annotateTerm(termFactory.makeAppl(out._consExtSDefInl_4, new IStrategoTerm[]{z_98, a_99, b_99, term}), checkListAnnos(termFactory, y_98));
