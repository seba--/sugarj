...
{ 
  ...
  { 
    ...
    { 
      ...
      t_109 = annos101;
      term = y_16.invoke(context, s_109);
      if(term == null)
        break Fail110;
      term = termFactory.annotateTerm(termFactory.makeAppl(out._consConstType_1, new IStrategoTerm[]{term}), checkListAnnos(termFactory, t_109));
