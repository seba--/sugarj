...
{ 
  ...
  { 
    ...
    { 
      ...
      if(term.getTermType() != IStrategoTerm.APPL || outt._consSwitchCase_2 != ((IStrategoAppl)term).getConstructor())
        break Fail62;
      ...
      if(term == null)
        break Fail62;
      term = termFactory.annotateTerm(termFactory.makeAppl(outt._consSwitchCase_2, new IStrategoTerm[]{f_109, term}), checkListAnnos(termFactory, e_109));
