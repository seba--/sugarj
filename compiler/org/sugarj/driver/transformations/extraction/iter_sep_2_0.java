...
{ 
  ...
  { 
    ...
    { 
      ...
      if(term.getTermType() != IStrategoTerm.APPL || outt._consiter_sep_2 != ((IStrategoAppl)term).getConstructor())
        break Fail234;
      ...
      if(term == null)
        break Fail234;
      term = termFactory.annotateTerm(termFactory.makeAppl(outt._consiter_sep_2, new IStrategoTerm[]{w_142, term}), checkListAnnos(termFactory, v_142));
