...
@SuppressWarnings("all") public class outt  
{ 
  ...
  { 
    ...
    constempty_grammar0 = termFactory.makeAppl(outt._consempty_grammar_0, NO_TERMS);
    const0 = termFactory.makeString("desugar");
    const1 = termFactory.makeString("changed-tree");
    constSVar0 = termFactory.makeAppl(outt._consSVar_1, new IStrategoTerm[]{extraction.const1});
    constCallNoArgs0 = termFactory.makeAppl(outt._consCallNoArgs_1, new IStrategoTerm[]{extraction.constSVar0});
  }
