...
{ 
  ...
  { 
    ...
    { 
      ...
      if(term.getTermType() != IStrategoTerm.APPL || outt._conssymbol_2 != ((IStrategoAppl)term).getConstructor())
        break Fail220;
      ...
      if(term == null)
        break Fail220;
      term = termFactory.annotateTerm(termFactory.makeAppl(outt._conssymbol_2, new IStrategoTerm[]{y_138, term}), checkListAnnos(termFactory, x_138));
