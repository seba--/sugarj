...
{ 
  ...
  { 
    ...
    { 
      ...
      if(term.getTermType() != IStrategoTerm.APPL || outt._consDynRuleIntersectFix_2 != ((IStrategoAppl)term).getConstructor())
        break Fail87;
      ...
      if(term == null)
        break Fail87;
      term = termFactory.annotateTerm(termFactory.makeAppl(outt._consDynRuleIntersectFix_2, new IStrategoTerm[]{m_114, term}), checkListAnnos(termFactory, l_114));
