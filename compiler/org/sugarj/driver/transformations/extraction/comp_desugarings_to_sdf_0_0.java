...
{ 
  ...
  { 
    ...
    { 
      ...
      term = map_1_0.instance.invoke(context, y_14, comp_desugaring_to_sdf_0_0.instance);
      if(term == null)
        break Fail11;
      ...
      term = termFactory.makeAppl(outt._conscontext_free_syntax_1, new IStrategoTerm[]{z_14});
