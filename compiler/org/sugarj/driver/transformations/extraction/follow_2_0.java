...
{ 
  ...
  { 
    ...
    { 
      ...
      if(term.getTermType() != IStrategoTerm.APPL || outt._consfollow_2 != ((IStrategoAppl)term).getConstructor())
        break Fail175;
      ...
      if(term == null)
        break Fail175;
      term = termFactory.annotateTerm(termFactory.makeAppl(outt._consfollow_2, new IStrategoTerm[]{q_129, term}), checkListAnnos(termFactory, o_129));
