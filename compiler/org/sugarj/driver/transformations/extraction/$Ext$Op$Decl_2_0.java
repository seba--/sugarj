...
{ 
  ...
  { 
    ...
    { 
      ...
      if(term.getTermType() != IStrategoTerm.APPL || outt._consExtOpDecl_2 != ((IStrategoAppl)term).getConstructor())
        break Fail142;
      ...
      if(term == null)
        break Fail142;
      term = termFactory.annotateTerm(termFactory.makeAppl(outt._consExtOpDecl_2, new IStrategoTerm[]{d_124, term}), checkListAnnos(termFactory, c_124));
