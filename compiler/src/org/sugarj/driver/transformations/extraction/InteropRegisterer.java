...
{ 
  ...
  { 
    ...
    varScope.addSVar("NativeSugarBody_1_0", new InteropSDefT(classLoader, "org.sugarj.driver.transformations.extraction.$Native$Sugar$Body_1_0", context));
    varScope.addSVar("SugarBody_1_0", new InteropSDefT(classLoader, "org.sugarj.driver.transformations.extraction.$Sugar$Body_1_0", context));
    varScope.addSVar("SuperSugarDec_1_0", new InteropSDefT(classLoader, "org.sugarj.driver.transformations.extraction.$Super$Sugar$Dec_1_0", context));
    varScope.addSVar("NativeSugarDecHead_3_0", new InteropSDefT(classLoader, "org.sugarj.driver.transformations.extraction.$Native$Sugar$Dec$Head_3_0", context));
    varScope.addSVar("SugarDecHead_2_0", new InteropSDefT(classLoader, "org.sugarj.driver.transformations.extraction.$Sugar$Dec$Head_2_0", context));
    varScope.addSVar("SugarDec_2_0", new InteropSDefT(classLoader, "org.sugarj.driver.transformations.extraction.$Sugar$Dec_2_0", context));
    varScope.addSVar("JavaTypeDec_1_0", new InteropSDefT(classLoader, "org.sugarj.driver.transformations.extraction.$Java$Type$Dec_1_0", context));
    varScope.addSVar("CompilationUnit_3_0", new InteropSDefT(classLoader, "org.sugarj.driver.transformations.extraction.$Compilation$Unit_3_0", context));
    ...
    varScope.addSVar("CompileError_2_0", new InteropSDefT(classLoader, "org.sugarj.driver.transformations.extraction.$Compile$Error_2_0", context));
    varScope.addSVar("EditorServicesDec_2_0", new InteropSDefT(classLoader, "org.sugarj.driver.transformations.extraction.$Editor$Services$Dec_2_0", context));
    varScope.addSVar("EditorServicesDecHead_2_0", new InteropSDefT(classLoader, "org.sugarj.driver.transformations.extraction.$Editor$Services$Dec$Head_2_0", context));
    varScope.addSVar("EditorServicesBody_1_0", new InteropSDefT(classLoader, "org.sugarj.driver.transformations.extraction.$Editor$Services$Body_1_0", context));
  }
}