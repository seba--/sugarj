...
{ 
  ...
  { 
    ...
    { 
      ...
      if(term.getTermType() != IStrategoTerm.APPL || ext_out._consExplodeCong_2 != ((IStrategoAppl)term).getConstructor())
        break Fail102;
      ...
      if(term == null)
        break Fail102;
      term = termFactory.annotateTerm(termFactory.makeAppl(ext_out._consExplodeCong_2, new IStrategoTerm[]{l_117, term}), checkListAnnos(termFactory, k_117));
