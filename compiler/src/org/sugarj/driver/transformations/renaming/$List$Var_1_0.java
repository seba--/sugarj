...
{ 
  ...
  { 
    ...
    { 
      ...
      b_96 = annos29;
      term = e_12.invoke(context, a_96);
      if(term == null)
        break Fail38;
      term = termFactory.annotateTerm(termFactory.makeAppl(out._consListVar_1, new IStrategoTerm[]{term}), checkListAnnos(termFactory, b_96));
